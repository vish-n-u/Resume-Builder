...
const ClassicTemplate = ({ data, accentColor }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-8 bg-white text-gray-800 leading-relaxed text-base">
            {/* Header */}
            <header className="text-center mb-8 pb-6 border-b-2" style={{ borderColor: accentColor }}>
                ...
                <div className="flex flex-wrap justify-center gap-4 text-base text-gray-600">
            ...
            {data.professional_summary && (
                <section className="mb-6">
                    ...
                    <p className="text-base text-gray-700 leading-relaxed">{data.professional_summary}</p>
                </section>
            )}
                        ...
                        {data.education.map((edu, index) => (
                            <div key={index} className="education-item flex justify-between items-start">
                                <div>
                                    ...
                                    {edu.gpa && <p className="text-base text-gray-600">GPA: {edu.gpa}</p>}
                                </div>
